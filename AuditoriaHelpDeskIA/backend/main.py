...
def extract_json_from_string(text: str) -> str:
    ...
    json_str = match.group(0) if match else '{"intent": "pregunta_general"}'
    # Si el modelo devolvió el esquema en lugar del dato
    if "properties" in json_str or "intent" not in json_str:
        return '{"intent": "pregunta_general"}'
    return json_str
